...
import com.HackRice.musicrun.com.musicrun.gameobjects.Grass;
import com.HackRice.musicrun.com.musicrun.gameobjects.Pipe;
...
public class GameRenderer {
    ...
    public void render(float runTime) {
        ...
        if (man.shouldntFlap()) {
            batcher.draw(birdMid, man.getX(), man.getY(),
                    man.getWidth() / 2.0f, man.getHeight() / 2.0f,
                    man.getWidth(), man.getHeight(), 1, 1, man.getRotation());

        } else {
            batcher.draw(birdAnimation.getKeyFrame(runTime), man.getX(),
                    man.getY(), man.getWidth() / 2.0f,
