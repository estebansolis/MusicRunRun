...
public class GameRenderer {
    ...
    public void render(float runTime) {
        ...
        shapeRenderer.rect(0, midPointY + 77, 136, 1);
        ...
        // The man needs transparency, so we enable that again.
        ...
        batcher.draw(AssetLoader.birdAnimation.getKeyFrame(runTime),
                man.getX(), man.getY(), man.getWidth(), man.getHeight());
